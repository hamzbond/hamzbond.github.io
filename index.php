            ...
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    <a class="logo" href="index.html">
                        ...
                        <span>
                            <img src="./plugins/images/logo-text.jpg" alt="homepage" class="dark-logo" />
                        </span>
                    </a>
                </div>
            ...
            <div class="scroll-sidebar">
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        <div class="profile-image">
                            <img src="./plugins/images/users/1.jpg" alt="user-img" class="img-circle">
                        ...
                        <p class="profile-text m-t-15 font-16"><a href="javascript:void(0);"> Achmad Hamzah</a></p>
                    </div>
                </div>
                <nav class="sidebar-nav">
                    <ul id="side-menu">
                        ...
                        <li>
                            <a class="active waves-effect" href="javascript:void(0);" aria-expanded="false"><i class="icon-docs fa-fw"></i> <span class="hide-menu"> Pages<span class="label label-rounded label-success pull-right">18</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <div class="col-md col-xs"> 
                            ...
                            <div class="user-bg"> 
                                ...
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white">Achmad Hamzah</h4>
                                        <h5 class="text-white">hamzbond@gmail.com</h5> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="tab">
                                    <a href="#messages" data-toggle="tab" aria-expanded="true"> <span class="visible-xs"><i class="fa fa-envelope-o"></i></span> <span class="hidden-xs">Education</span> </a>
                                </li>
                                <li class="tab">
                                    <a href="#settings" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="fa fa-cog"></i></span> <span class="hidden-xs">Experience</span> </a>
                                </li>
                                <li class="tab">
                                    <a href="#settings" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"><i class="fa fa-cog"></i></span> <span class="hidden-xs">Certifications</span> </a>
                                </li>
                            </ul>
